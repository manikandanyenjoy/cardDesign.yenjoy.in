...
class PurchaseorderController extends Controller
{
    public function index(Request $request)
    {
         ...
         $wovens = DesignCard::with(['salesRepDetail','customerDetail'])->where('po_status',1);
        ...
        if($request->search){
          ...
          $wovens->where(function ($query) use ($columnsToSearch,$searchQuery) {
        ...
        return view("purchaseorder.index", compact("wovens"));
    }
    ...
    public function show($woven)
    {
        ...
        return view("purchaseorder.show", compact("viewDesignCard","weavers"));
    }
