...
@section('title', 'Create wovenquality')

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('Create wovenquality') }}</h1>
        </div>
        <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary" style="width: 850px;" >
                        <div class="card-header">
                            <h3 class="card-title">Create wovenquality</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('wovenqualitys.store') }}" novalidate>
                            @csrf
