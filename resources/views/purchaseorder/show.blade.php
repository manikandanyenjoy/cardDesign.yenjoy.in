...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-12 pr-4 d-flex justify-content-end">
            ...
            <a href="{{ route('purchaseorder.edit',$viewDesignCard->id) }}" class="btn col-1 bg-gradient-primary mr-3">Edit</a>
            <a href="{{ route('purchaseorder.index') }}" class="btn col-1 bg-gradient-danger">Back</a>
        </div>
    </div>
@stop
